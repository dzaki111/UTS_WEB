...
let dataKatalogBuku = [ 
    ...
    },
    {
        ...
        stok: 204,
        harga: 250000,
        hargaFormat: "Rp 250.000",
        cover: "assets/img/paud_perkembangan.jpg" 
    }
];

// Data Tracking Pengiriman (TETAP SAMA)
...
// Fungsi utilitas untuk format mata uang (TETAP SAMA)
...
// Ekspor data dan fungsi (TETAP SAMA)
window.dataUsers = dataUsers;
window.dataKatalogBuku = dataKatalogBuku;
window.dataTrackingPengiriman = dataTrackingPengiriman;
